...
3. После этого можно проверить корректность установки, для этого пишем:
   ...
   vcpkg --vercion
   ```
   В случае корректной установки, в консоль будет выведено `vcpkg package management program version 2024-11-12-eb492805e92a2c14a230f5c3deb3e89f6771c321`, где `2024-11-12-eb492805e92a2c14a230f5c3deb3e89f6771c321`- комбинация из даты сборки программы и хэш коммита в репозитории Git
