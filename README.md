...
**!!! Важное уточнение !!! После выполнения первой команды ниже, возможно скачается и protobuf, у многих скачивало сразу, выполняем команды по очереди и смотрим, что выводится в консоль**
